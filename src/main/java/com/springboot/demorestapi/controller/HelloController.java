package com.springboot.demorestapi.controller;


import com.springboot.demorestapi.entity.Student;
...
public class HelloController {
    ...
    public List<Student> getStudents(){
        ...
        students.add(new Student(1, "Vani", "MK"));
        students.add(new Student(2, "Vee", "Fadatare"));
